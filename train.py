...
def evaluate(valid_pkl_path, loss_criterion, model, config, vocab_size, vocab, annoyIndex, 
			annoyPkl, use_cuda=False, use_kb=False, use_aspect=False, valid_aspect_path=None, valid_kb_path=None, 
	...
	for batch_id in range(num_valid_batch):
		...
		if use_aspect:
			...
			aspect_len =  utils.convert_states_to_torch(aspect_len, use_cuad=use_cuda)
	...
	for epoch in range(config['training']['num_epochs']):
		...
		if (epoch+1) % config['training']['evaluate_every'] == 0:
			...
			evaluate(args.valid_pkl_path, loss_criterion, model, config, vocab_size, vocab,\
					annoyIndex, annoyPkl, use_cuda=use_cuda, use_kb=use_kb, use_aspect=use_aspect,valid_aspect_path=args.valid_aspect_path,
